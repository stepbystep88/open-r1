    ...
    def __init__(
        ...
        if self.use_vllm:
            ...
            if self.accelerator.is_main_process:
                ...
                # vllm_device = args.vllm_device or f"npu:{self.accelerator.num_processes}"
                vllm_device = args.vllm_device or f"npu:{torch.npu.current_device()}"
